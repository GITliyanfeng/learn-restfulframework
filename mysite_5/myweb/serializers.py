...
# 通过模型的简化版本
class CodeSegmentSerializers(serializers.ModelSerializer):
...
class UserSerializers(serializers.ModelSerializer):
    CodeSegments = serializers.PrimaryKeyRelatedField(many=True, queryset=CodeSegment.objects.all())

    class Meta:
        model = User
        fields = ('id', 'username', 'CodeSegments')
